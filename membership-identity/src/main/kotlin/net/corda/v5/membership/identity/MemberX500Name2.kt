...
class MemberX500Name2 (
    ...
    companion object {
        ...
        @JvmStatic
        fun build(principal: X500Principal): MemberX500Name2 {
            ...
            return MemberX500Name2(CN, OU, O, L, ST, C)
        }

        @JvmStatic
        fun parse(name: String): MemberX500Name2 = build(X500Principal(name))
    }
